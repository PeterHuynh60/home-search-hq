  ...
  return (
    <div style={{background:C.card,borderRadius:12,border:"1px solid "+C.cardBorder,overflow:"hidden",boxShadow:"0 1px 4px #0001"}}>
      ...
      <div style={{display:"flex",alignItems:"stretch"}}>
        {h.photoUrl && <div style={{width:ex?"30%":"120px",minWidth:ex?180:120,maxWidth:ex?280:120,flexShrink:0,overflow:"hidden",background:C.inputBg,transition:"all 0.3s ease"}}>
